...
- IMPORTANT: In Original sections, show only the FIRST THREE LINES of each prompt followed by "..." to keep the report concise`
    },
    {
      ...
      content: [
        ...
        '→ [Potential production impact] (Do not include the best practice references in the evidence)',
        '',
        ...
        '2. **Run baseline evals** on your real logs: [specific metrics based on prompts]',
